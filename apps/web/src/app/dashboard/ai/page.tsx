...
import { ConsultationFilters, TRIAGE_OPTIONS, FilterOptions } from '@/lib/analytics-types';
...
export default function AiPage() {
  ...
  }, [debouncedSearch, filters.triageLevel, filters.utId, filters.page, user, authLoading]);
  ...
  return (
    <DashboardLayout title="AI Tahlil markazi" subtitle="Smart filter va chuqur tahlil">
      <div className="space-y-4">
        {insights && (
          <div className="grid grid-cols-3 gap-3 animate-slide-up">
            <div className="panel p-4 text-center">
              ...
              <p className="text-[10px] text-slate-500">O&apos;rtacha ishonch</p>
            </div>
            <div className="panel p-4 text-center">
              <Brain size={20} className="text-brand-600 mx-auto mb-1" />
              <p className="text-xl font-bold text-slate-900">{insights.diagnosisMatchRate ?? '—'}%</p>
              <p className="text-[10px] text-slate-500">Tashxis mosligi</p>
            </div>
            <div className="panel p-4 text-center">
              ...
              <p className="text-[10px] text-slate-500">Qizil bayroqlar</p>
            </div>
          </div>
        )}
        ...
        <SmartFilterBar
          fields={[
            { key: 'search', label: 'Qidirish', type: 'search', value: filters.search || '', placeholder: 'Bemor, tashxis, ICD-10...' },
          ...
          <>
            ...
            {items.length === 0 && (
              <div className="empty-state panel min-h-[300px]">
                ...
                <p className="font-medium text-slate-500">AI tahlil natijalari topilmadi</p>
              </div>
            )}
